          ...
          Scaffold(
            ...
            floatingActionButton: SizedBox(
              ...
              child: FloatingActionButton(
                ...
                backgroundColor: const Color(0xFFFDBD03), // Warna kuning sesuai desain
                onPressed: () {
                  Get.dialog(
                    AlertDialog(
                ...
                child: Icon(Icons.add, size: isLandscape ? 30 : 36, color: Colors.white),
              ),
            ),
            ...
            bottomNavigationBar: BottomAppBar(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    _buildNavItem(Icons.home, "Home", 0, isLandscape: isLandscape),
                    _buildNavItem(Icons.store, "Toko", 1, isLandscape: isLandscape),
                    const SizedBox(width: 40), // Space for FAB
                    _buildNavItem(Icons.history, "Riwayat", 3, isLandscape: isLandscape),
                    _buildNavItem(Icons.person, "Profile", 4, isLandscape: isLandscape),
                  ],
                ),
              ),
            ),
